...
import { FIRCase, PoliceStationName, InvestigatingOfficer, UserRole, PunishmentTerm } from '../types';
import { getPSFromRole } from '../utils/helpers';
import { X, Shield, Plus, Calendar, MapPin, User, FileText, Clock, Scale } from 'lucide-react';
