              ...
              return (
                <tr key={c.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                  ...
                  <td className="py-3 px-4">
                    ...
                    {c.chargesheetDate && (
                      <div className="text-[10px] text-emerald-700 dark:text-emerald-400 font-bold flex items-center gap-1 mt-0.5" title={`Chargesheet filed on ${c.chargesheetDate}`}>
                  ...
                  <td className="py-3 px-4 max-w-xs">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span className="font-bold text-slate-800 dark:text-slate-200 truncate" title={c.sections}>
                        {c.sections}
                      </span>
                      {c.punishmentTerm && (
                        <span className={`inline-block text-[9px] font-extrabold px-1.5 py-0.5 rounded shrink-0 ${
