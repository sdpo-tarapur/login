          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-lg text-xs font-bold transition-all whitespace-nowrap flex items-center gap-2 relative ${
              activeTab === 'ai_assistant'
                ? 'bg-gradient-to-r from-purple-900 to-indigo-900 text-white border-b-2 border-purple-400 shadow-xs'
                : 'text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-950/60'
            }`}
          >
            <Bot className="w-4 h-4 text-purple-400 animate-pulse" />
            <span>AI Assistant</span>
            <span className="px-1.5 py-0.2 text-[9px] uppercase font-black bg-purple-500/30 text-purple-200 border border-purple-400/30 rounded-full">
              Gemini AI
            </span>
          </button>
        </div>
